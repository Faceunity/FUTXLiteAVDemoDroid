...
import static com.tencent.liteav.audiosettingkit.utils.ResourceUtils.getResources;
            ...
            switch (eventId) {
                ...
                case TXLiveConstants.PLAY_EVT_START_VIDEO_DECODER:
                    ...
                    if (mode == DECODER_HARD) {
                        updateItemText(LogInfo.createStep2LogInfo(mContext.getString(R.string.liveplayer_text_hw_decode_start)));
                    } else {
